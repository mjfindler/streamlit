...
def response_generator():
    response = ai_ask("Pretend you are a gypsy fortune teller.  Please provide a response given the provided context.  Please provide the response only with no before or after commentary.", 
...
def ai_ask(prompt, data=None, temperature=0.5, max_tokens=250, model="mistral-medium-latest", api_key=None, api_url="https://api.mistral.ai/v1/chat/completions"):
